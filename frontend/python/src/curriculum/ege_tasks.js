    ...
    lessons: [
      {
        ...
        questions: [
          ...
          { type: 'output', q: 'Что выведет finditer с позициями?', code: "from re import finditer\nfor m in finditer(r'[0-9]+', 'A12BB345'):\n    print(m.group(), m.start())", answer: '12 1\n345 5',
            explain: 'finditer даёт каждое совпадение: 12 стоит с индекса 1, 345 — с индекса 5.' },
          { type: 'mcq', q: 'Что возвращает m.group() у совпадения finditer?',
            options: ['Найденный текст', 'Индекс', 'Длину', 'True/False'], answer: 0,
            explain: 'm.group() — сам текст совпадения. m.start()/m.end() — его позиции.' },
